...
numVehicleVertices = length(results{1}.vehicleStateTime);
fprintf('the number of vehicle poses = %.0d. \n', numVehicleVertices);

numbOfLandmarks = length(allVertices) - numVehicleVertices;
fprintf('the number of landmarks initialized = %.0d. \n', numbOfLandmarks);

landmarkObservationEdges = length(allEdges) - numVehicleVertices + 1;

landmarkObservationsPerVehicleVertex = landmarkObservationEdges / numVehicleVertices;
fprintf('the average number of observations made by a robot at each timestep = %.2f. \n', landmarkObservationsPerVehicleVertex);

observationsPerLandmarkVertex = landmarkObservationEdges / numbOfLandmarks;
fprintf('the average number of observations received by each landmark = %.2f. \n', observationsPerLandmarkVertex);
